...
// IMAGE SETUP
// -----------
// Place your food images inside:  src/images/
//
// Required filenames (jpg or png — update IMG_EXT below if using .png):
//   idli.jpg | dosa.jpg | pesarattu.jpg | upma.jpg | pongal.jpg | poori.jpg
//   vada.jpg | meals.jpg | rice.jpg | biryani.jpg | bajji.jpg | punugulu.jpg
//   pakora.jpg | samosa.jpg | laddu.jpg | mysorepa.jpg | ariselu.jpg | gulabjamun.jpg
//   hero-bg.jpg  (hero section background — optional)
//   category-tiffins.jpg | category-meals.jpg | category-hot.jpg | category-sweets.jpg
//
// If an image file is missing the component shows a coloured placeholder automatically.
// ─────────────────────────────────────────────────────────────────────────────

const IMG_EXT = "jpg"; // change to "png" if your images are .png files

// Import all images statically so Vite bundles them correctly
// Add / remove imports here as your image library grows
import imgIdli        from "./images/idli.jpg";
import imgDosa        from "./images/dosa.jpg";
import imgPesarattu   from "./images/pesarattu.jpg";
import imgUpma        from "./images/upma.jpg";
import imgSemiyaUpma  from "./images/semiyaupma.jpg";
import imgPongal      from "./images/pongal.jpg";
import imgPoori       from "./images/poori.jpg";
import imgVada        from "./images/vada.jpg";
import imgMeals       from "./images/meals.jpg";
import imgRice        from "./images/rice.jpg";
import imgBiryani     from "./images/biryani.jpg";
import imgBajji       from "./images/bajji.jpg";
import imgPunugulu    from "./images/punugulu.jpg";
import imgPakora      from "./images/pakora.jpg";
import imgSamosa      from "./images/samosa.jpg";
import imgLaddu       from "./images/laddu.jpg";
import imgMysorepa    from "./images/mysorepa.jpg";
import imgAriselu     from "./images/ariselu.jpg";
import imgGulabjamun  from "./images/gulabjamun.jpg";
import imgHeroBg      from "./images/hero-bg.jpg";
import imgCatTiffins  from "./images/category-tiffins.jpg";
import imgCatMeals    from "./images/category-meals.jpg";
import imgCatHot      from "./images/category-hot.jpg";
import imgCatSweets   from "./images/category-sweets.jpg";
import imgVegMaggi    from "./images/vegmaggi.jpg";
import imgSunnivundalu  from "./images/sunnivundalu.jpg";
import imgLogo from "./images/logo.jpg";

// Map key → imported image URL
const IMAGE_MAP = {
  idli:              imgIdli,
  dosa:              imgDosa,
  pesarattu:         imgPesarattu,
  upma:              imgUpma,
  pongal:            imgPongal,
  poori:             imgPoori,
  vada:              imgVada,
  ...
  biryani:           imgBiryani,
  bajji:             imgBajji,
  punugulu:          imgPunugulu,
  pakora:            imgPakora,
  samosa:            imgSamosa,
  laddu:             imgLaddu,
  mysorepa:          imgMysorepa,
  ariselu:           imgAriselu,
  gulabjamun:        imgGulabjamun,
  "hero-bg":         imgHeroBg,
  "category-tiffins":imgCatTiffins,
  "category-meals":  imgCatMeals,
  "category-hot":    imgCatHot,
  "category-sweets": imgCatSweets,
  semiyaupma:      imgSemiyaUpma,
  vegmaggi:      imgVegMaggi,
  sunnivundalu:      imgSunnivundalu
};

// Placeholder colours shown when an image key has no match
const PLACEHOLDER_COLORS = {
  idli: "#fff5e6", dosa: "#fff3e0", pesarattu: "#f0f9e8", upma: "#faf5e4",
  pongal: "#fffbf0", poori: "#fff8e8", vada: "#fff5e0", meals: "#f5f0e8",
  rice: "#fffff0", biryani: "#fff8e0", bajji: "#fff0e0", punugulu: "#fff5e8",
  pakora: "#fff3e0", samosa: "#fef9e7", laddu: "#fff5e0", mysorepa: "#fffbe6",
  ariselu: "#fff8f0", gulabjamun: "#fff0f5",
  "category-tiffins": "#fff5e6", "category-meals": "#f5f0e8",
  "category-hot": "#fff0e0", "category-sweets": "#fff0f5",
  default: "#f5f0e8",
};

// ─── CONFIG ──────────────────────────────────────────────────────────────────
const CONFIG = {
  WHATSAPP_NUMBER: "919581344345",
  BRAND_NAME: "TK Home Foods",
  TAGLINE: "Authentic Telangana & Andhra Home Made Food.",
...
const CATEGORIES = [
  {
    ...
    icon: "🍱", catImg: "category-tiffins",
    description: "Freshly prepared South Indian breakfast and traditional tiffins.",
    color: "#e8520a",
    items: ["Idli", "Plain Dosa", "Upma", "Vada", "Ghee Karam Idli", "Masala Dosa", "Pesarattu",  "Pongal", "Poori"],
  },
  // {
  //   id: "meals", slug: "meals-rice", name: "Rice",
  //   icon: "🍚", catImg: "category-meals",
  ...
  // },
  // {
  //   id: "hot-items", slug: "hot-items", name: "Hot Items",
  //   icon: "🔥", catImg: "category-hot",
  ...
  // },
  {
    id: "sweets", slug: "sweets", name: "Sweets",
    icon: "🧆", catImg: "category-sweets",
    description: "Traditional handmade sweets with authentic flavours.",
    color: "#9333ea",
    items: ["Boondi Laddu", "Sunnundalu", "Palli Patti", "Ravva Laddu", "Mysore Pak", "Ariselu", "Gulab Jamun", "Badusha", "Seasonal Specials"],
  },
];

const MENU_ITEMS = [
  // Tiffins
  { id: 1,  category: "tiffins",    name: "Idli<br/>Quantity : 4 (Per Plate)",   desc1: "Soft steamed idlis — a classic Andhra morning treat.",              price: 40,  veg: true,  featured: true,  special: false, rating: 4.8, img: "idli" },
  { id: 2,  category: "tiffins",    name: "Plain Dosa<br/>Quantity : 2 (Per Plate)",         desc1: "Light, thin and crispy rice crepe served with fresh chutney and sambar.",                        price: 60,  veg: true,  featured: false, special: false, rating: 4.5, img: "dosa" },
  { id: 3,  category: "tiffins",    name: "Vada / Gaarelu<br/>Quantity : 3 (Per Plate)",     desc1: "Crispy fried lentil doughnuts served hot with coconut chutney and sambar.",                      price: 60,  veg: true,  featured: false, special: false, rating: 4.6, img: "vada" },
  ...
  { id: 5,  category: "tiffins",    name: "Semiya Upma",        desc1: "Tossing roasted vermicelli with sautéed vegetables, mustard seeds, and aromatic spices.",         price: 50,  veg: true,  featured: false, special: false, rating: 4.6, img: "semiyaupma" },
  { id: 6,  category: "tiffins",    name: "Veg Maggi",   desc1: "Soft steamed idlis tossed in ghee and karam podi — a classic Andhra morning treat.",              price: 50,  veg: true,  featured: true,  special: false, rating: 4.8, img: "vegmaggi" },
// { id: 9,  category: "tiffins",    name: "Ghee Karam Idli",   desc1: "Soft steamed idlis tossed in ghee and karam podi — a classic Andhra morning treat.",              price: 60,  veg: true,  featured: true,  special: false, rating: 4.8, img: "idli" },
 ...
 // Meals
  { id: 9,  category: "meals",      name: "Andhra Veg Meals",   desc1: "Full Andhra thali with rice, sambar, rasam, 3 curries, pappad and pickle.",                      price: 130, veg: true,  featured: false,  special: true,  rating: 4.9, img: "meals" },
  ...
  { id: 11, category: "meals",      name: "Pulihora",           desc1: "Tangy tamarind rice with peanuts and curry leaves — a festival favourite.",                      price: 80,  veg: true,  featured: false,  special: false, rating: 4.7, img: "rice" },
  { id: 12, category: "meals",      name: "Veg Biryani",        desc1: "Aromatic basmati biryani loaded with vegetables and fresh mint.",                                price: 150, veg: true,  featured: false,  special: true,  rating: 4.8, img: "biryani" },
  ...
  // Hot Items
  { id: 15, category: "hot-items",  name: "Mirchi Bajji",       desc1: "Long green chillies dipped in spiced besan batter, deep fried till golden.",                    price: 60,  veg: true,  featured: false,  special: true,  rating: 4.9, img: "bajji" },
  { id: 16, category: "hot-items",  name: "Punugulu",           desc1: "Crispy fermented batter bites — Andhra's favourite tea-time snack.",                            price: 50,  veg: true,  featured: false,  special: false, rating: 4.8, img: "punugulu" },
  ...
  { id: 19, category: "hot-items",  name: "Samosa",             desc1: "Flaky pastry filled with spiced potato and peas, served with mint chutney.",                    price: 20,  veg: true,  featured: false,  special: false, rating: 4.5, img: "samosa" },
  // Sweets
  { id: 20, category: "sweets",     name: "Boondi Laddu<br/>Quantity : 24 (Per Kg)",       desc1: "Soft round sweets made from chickpea flour pearls, ghee and cardamom.",                         price: 700,  veg: true,  featured: true,  special: false, rating: 4.9, img: "laddu" },
  { id: 21, category: "sweets",     name: "Sunnivundalu<br/>Quantity : 24 (Per Kg)",         desc1: "Urad dal laddus with ghee and sugar — nutritious and delicious.",                               price: 950,  veg: true,  featured: false, special: false, rating: 4.6, img: "sunnivundalu" }
  // { id: 21, category: "sweets",     name: "Mysore Pak",         desc1: "Melt-in-the-mouth ghee and gram flour sweet — a South Indian classic.",                         price: 40,  veg: true,  featured: false,  special: true,  rating: 4.8, img: "mysorepa" },
  ...
  // { id: 24, category: "sweets",     name: "Gulab Jamun",        desc1: "Soft khoya dumplings soaked in rose-scented sugar syrup.",                                      price: 25,  veg: true,  featured: false,  special: true,  rating: 4.9, img: "gulabjamun" },
];

const TODAYS_SPECIALS = MENU_ITEMS.filter(i => i.special);

const TESTIMONIALS = [
  { id: 1, name: "Priya Reddy",   location: "Miyapur",      rating: 5, avatar: "P", text: "The Andhra Veg Meals taste exactly like homemade food! The sambar is rich and the curries are perfectly spiced. My family loves it every day." },
  { id: 2, name: "Suresh Kumar",  location: "KPHB Colony",  rating: 5, avatar: "S", text: "Pesarattu and Punugulu are my go-to order. Crispy, fresh and so authentic. Reminds me of my hometown in Andhra. Great work, TK Home Foods!" },
  { id: 3, name: "Lakshmi Devi", location: "Chandanagar",  rating: 5, avatar: "L", text: "Ordered Boondi Laddu and Mysore Pak for Diwali. The quality was exceptional. Fresh, tasty and packed nicely. Will order again for every occasion!" },
  { id: 4, name: "Ravi Teja",    location: "Hafeezpet",    rating: 4, avatar: "R", text: "The Mirchi Bajji and Punugulu in the evenings are absolutely amazing. Best hot snacks in the Miyapur area. Delivery is also quick and reliable." },
  { id: 5, name: "Anitha Rao",   location: "Nizampet",     rating: 5, avatar: "A", text: "I get the weekly meal plan every week. The food is fresh, hygienic and tastes authentic. Love that they use traditional recipes. Highly recommended!" },
];
...
// Loads from IMAGE_MAP; shows a coloured placeholder if the image hasn't loaded.
// - alt   : screen-reader text (shown when image fails to load)
// - title : browser tooltip shown on mouse hover
function FoodImg({ imgKey, alt, style = {}, className = "" }) {
  const [errored, setErrored] = useState(false);
  const src = IMAGE_MAP[imgKey];
  const placeholderBg = PLACEHOLDER_COLORS[imgKey] || PLACEHOLDER_COLORS.default;
  // helper — reuse wherever needed
  const plainTitle = (name) => name.replaceAll("<br/>", "\n");
  ...
  if (!src || errored) {
    // Graceful placeholder — branded colour + emoji
    const emoji = {
      idli:"🫓", dosa:"🥞", pesarattu:"🥬", upma:"🍲", pongal:"🍲",
      poori:"🫓", vada:"🍩", meals:"🍽️", rice:"🍚", biryani:"🍛",
      bajji:"🌶️", punugulu:"🟤", pakora:"🧅", samosa:"🥟", laddu:"🟡",
      mysorepa:"🟨", ariselu:"🟤", gulabjamun:"🟤",
    }[imgKey] || "🍽️";
    ...
    return (
      <div
        ...
        title={alt}
        aria-label={alt}
        style={{ ...baseStyle, background: placeholderBg,
          display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "6px" }}>
        <span style={{ fontSize: "clamp(28px,6vw,44px)" }}>{emoji}</span>
        <span style={{ fontSize: "11px", color: "#9ca3af", fontWeight: 500 }}>{alt}</span>
      </div>
    );
  }
...
function VegBadge({ veg }) {
  return (
    <span style={{
      ...
      {/* FSSAI standard symbols */}
      <svg width="14" height="14" viewBox="0 0 14 14">
        <rect x="1" y="1" width="12" height="12" rx="1.5"
          fill="none" stroke={veg ? "#008000" : "#8B0000"} strokeWidth="1.5"/>
        {veg
          ? <circle cx="7" cy="7" r="3.5" fill="#008000"/>
          : <polygon points="7,2.5 12,11.5 2,11.5" fill="#8B0000"/>}
      </svg>
      <span style={{ fontSize: "10px", fontWeight: 700, color: veg ? "#008000" : "#8B0000" }}>
        {veg ? "VEG" : "NON-VEG"}
      </span>
    </span>
  );
...
function Stars({ rating }) {
  return (
    <span aria-label={`${rating} out of 5 stars`}>
      {[1,2,3,4,5].map(n => (
        <span key={n} style={{ color: n <= Math.floor(rating) ? "#f59e0b" : "#d1d5db", fontSize: "12px" }}>★</span>
      ))}
...
function FoodCard({ item, compact = false }) {
  ...
  return (
    <div
      ...
      {/* Image */}
      <div style={{ height: compact ? "140px" : "450px", flexShrink: 0, position: "relative", overflow: "hidden" }}>
        <FoodImg imgKey={item.img} alt={item.name} style={{ borderRadius: 0 }} />
        <VegBadge veg={item.veg} />
        {item.special && (
          <span style={{ position: "absolute", top: "10px", right: "10px",
            background: "#c0390a", color: "#fff", borderRadius: "20px",
      ...
      <div style={{ padding: "14px 16px 16px", flex: 1, display: "flex", flexDirection: "column" }}>
        <h3 style={{ margin: "0 0 4px", fontSize: compact ? "14px" : "15px", fontWeight: 700, color: "#1c1917" }}>
         {item.name.includes("<br/>")    ? item.name.split("<br/>").map((part, index) => (
        ...
        {!compact && (
          <p style={{ margin: "0 0 8px", fontSize: "12px", color: "#6b7280", lineHeight: 1.5, flex: 1 }}>
            {item.desc}
          </p>
        )}
...
function Nav({ currentPage, setPage }) {
  ...
  <img
    src={imgLogo}
    alt="TK Home Foods Logo"
    title="TK Home Foods"
    style={{
      width: "48px",
      height: "48px",
      borderRadius: "50%",       // circle shape — matches your logo
      objectFit: "cover",
      border: "2px solid #c0390a",
    }}
  />
  <div style={{ textAlign: "left" }}>
    <div style={{ fontSize: "16px", fontWeight: 800, color: "#1c1917", lineHeight: 1.1 }}>TK Home Foods</div>
   { /* <div style={{ fontSize: "10px", color: "#c0390a", fontWeight: 600 }}>Miyapur, Hyderabad2</div>*/}
  </div>
</button>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            {/* <button onClick={() => setIsCartOpen(true)} style={{
              ...
              {count > 0 && (
                <span style={{
                  background: "#c0390a", color: "#fff", borderRadius: "50%",
            ...
            <button onClick={() => go("checkout")} className="desktop-nav" style={{
              background: "#c0390a", color: "#fff", border: "none",
        ...
        {menuOpen && (
          <div style={{ background: "#fff", borderTop: "1px solid #f3f4f6", padding: "12px 20px 20px" }}>
            ...
            <button onClick={() => { go("checkout"); setMenuOpen(false); }} style={{
              marginTop: "12px", width: "100%", background: "#c0390a", color: "#fff",
              border: "none", borderRadius: "8px", padding: "13px", fontSize: "15px", fontWeight: 700, cursor: "pointer",
            }}>Order Now</button>
          </div>
        )}
      </nav>
      ...
      <div className="mobile-only" style={{
        ...
        {[
          ...
          { key: "cart-mobile", icon: "🛒", label: count > 0 ? `Cart (${count})` : "Cart" },
          { key: "contact",     icon: "📞", label: "Contact" },
        ].map(b => (
          <button key={b.key}
            onClick={() => b.key === "cart-mobile" ? setIsCartOpen(true) : go(b.key)}
            style={{ flex: 1, background: "none", border: "none", padding: "10px 4px 12px",
  ...
  return (
      ...
      <div style={{
        ...
        <div style={{ padding: "20px", borderBottom: "1px solid #f3f4f6",
          ...
          <h2 style={{ margin: 0, fontSize: "18px", fontWeight: 700 }}>
            Your Cart {count > 0 && <span style={{ color: "#c0390a" }}>({count})</span>}
          </h2>
        ...
        {cart.length === 0 ? (
          <div style={{ flex: 1, display: "flex", flexDirection: "column",
            ...
            <button onClick={() => setIsCartOpen(false)}
              style={{ background: "#c0390a", color: "#fff", border: "none",
              ...
              {cart.map(item => (
                <div key={item.id} style={{
                  ...
                  <div style={{ width: "56px", height: "56px", borderRadius: "10px", overflow: "hidden", flexShrink: 0 }}>
                    <FoodImg imgKey={item.img} alt={item.name} />
                  </div>
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: 600, fontSize: "14px", color: "#1c1917" }}>{item.name.includes("<br/>")
    ? item.name.split("<br/>").map((part, index) => (
        <span key={index} style={{ display: "block" }}>
          {part}
        </span>
      ))
    : item.name}</div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    {["−","+"].map((sym, idx) => (
                      <button key={sym} onClick={() => updateQty(item.id, idx === 0 ? -1 : 1)} style={{
            ...
            <div style={{ padding: "16px 20px", borderTop: "1px solid #f3f4f6" }}>
              {[["Subtotal", `₹${total}`], ["Delivery", `₹${delivery}`]].map(([l,v]) => (
                <div key={l} style={{ display: "flex", justifyContent: "space-between",
                  marginBottom: "6px", fontSize: "14px", color: "#6b7280" }}>
                  <span>{l}</span><span>{v}</span>
                </div>
              ))}
              <div style={{ display: "flex", justifyContent: "space-between",
                marginBottom: "16px", fontWeight: 700, fontSize: "16px" }}>
                <span>Total</span>
                <span style={{ color: "#c0390a" }}>₹{total + delivery}</span>
              </div>
              <button onClick={() => { setIsCartOpen(false); setPage("checkout"); window.scrollTo(0,0); }}
                style={{ width: "100%", background: "#c0390a", color: "#fff", border: "none",
...
function HomePage({ setPage }) {
  ...
  return (
    <main>
      {/* ── HERO ── */}
      <section style={{
        background: "linear-gradient(135deg,#fef7ef 0%,#fff5e6 40%,#fef2f2 100%)",
        padding: "100px 20px 70px", minHeight: "85vh", display: "flex", alignItems: "center",
      }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%",
          ...
          <div>
           {/* <div style={{ display: "inline-flex", alignItems: "center", gap: "6px",
              background: "#fde8e0", borderRadius: "20px", padding: "6px 14px", marginBottom: "20px" }}>
              <span style={{ fontSize: "12px" }}>📍</span>
              <span style={{ fontSize: "13px", color: "#c0390a", fontWeight: 600 }}>Matrusri Nagar, Miyapur, Hyderabad1</span>
            </div>*/}
            <h1 style={{ fontSize: "clamp(28px,4.5vw,50px)", fontWeight: 900, color: "#1c1917",
            ...
            <p style={{ fontSize: "17px", color: "#4b5563", lineHeight: 1.7, margin: "0 0 32px", maxWidth: "480px" }}>
              Freshly prepared tiffins, wholesome meals, hot snacks and traditional sweets —
              bringing the authentic taste of home to your table.
            </p>
            <div style={{ display: "flex", gap: "14px", flexWrap: "wrap" }}>
              <button onClick={() => { setPage("tiffins"); window.scrollTo(0,0); }}
                style={{ background: "#c0390a", color: "#fff", border: "none",
                  borderRadius: "10px", padding: "14px 28px", fontSize: "15px", fontWeight: 700, cursor: "pointer" }}>
                View Our Menu
              </button>
              {/* <button onClick={whatsappOrder} style={{
                background: "#fff", color: "#1c1917", border: "2px solid #e5e7eb",
                borderRadius: "10px", padding: "14px 28px", fontSize: "15px", fontWeight: 700,
          ...
          <div className="desktop-nav" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
            {[
              { imgKey: "idli",     label: "Idli" },
              { imgKey: "vada",     label: "Vada" },
              { imgKey: "laddu",    label: "Boondi Laddu" },
              { imgKey: "sunnivundalu",    label: "Sunnivundalu" }
              // { imgKey: "meals",    label: "Andhra Meals" },
              // { imgKey: "bajji",    label: "Mirchi Bajji" },
            ].map((f, i) => (
              <div key={f.imgKey} style={{
                borderRadius: "16px", overflow: "hidden",
                boxShadow: "0 4px 20px rgba(0,0,0,0.1)",
                transform: i % 2 === 1 ? "translateY(20px)" : "none",
              }}>
                <div style={{ height: "130px" }}>
                  <FoodImg imgKey={f.imgKey} alt={f.label} />
                </div>
      ...
      <section style={{ padding: "70px 20px", background: "#fff" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <div style={{ fontSize: "13px", fontWeight: 700, color: "#c0390a",
              letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "8px" }}>
              Explore Our Menu
            </div>
            <h2 style={{ fontSize: "clamp(24px,3.5vw,36px)", fontWeight: 900, color: "#1c1917", margin: 0 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "20px" }}>
            {CATEGORIES.map(cat => (
              <button key={cat.id} onClick={() => { setPage(cat.id); window.scrollTo(0,0); }} style={{
                background: "#fff", border: "2px solid #f3f4f6", borderRadius: "20px",
              ...
              onMouseLeave={e => { e.currentTarget.style.borderColor = "#f3f4f6"; e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = "0 2px 8px rgba(0,0,0,0.05)"; }}>
                {/* Category image */}
                <div style={{ height: "140px", overflow: "hidden" }}>
                  <FoodImg imgKey={cat.catImg} alt={cat.name}
                ...
                <div style={{ padding: "20px 20px 22px" }}>
                  ...
                  <h3 style={{ margin: "0 0 6px", fontSize: "17px", fontWeight: 800, color: "#1c1917" }}>{cat.name}</h3>
                  <p style={{ margin: "0 0 14px", fontSize: "13px", color: "#6b7280", lineHeight: 1.5 }}>{cat.description}</p>
                  <div style={{ marginBottom: "14px" }}>
                    {cat.items.slice(0, 4).map(it => (
                      <span key={it} style={{
                        display: "inline-block", background: "#f9fafb", border: "1px solid #e5e7eb",
                        borderRadius: "6px", padding: "3px 8px", fontSize: "11px", color: "#374151", margin: "2px",
                      }}>{it} </span>
                    ))}
                  </div>
      ...
      <section style={{ padding: "70px 20px", background: "linear-gradient(135deg,#fff8f5,#fff)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between",
            ...
            <div>
              <div style={{ fontSize: "13px", fontWeight: 700, color: "#c0390a",
                letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "6px" }}>🔥 Today's Specials</div>
              <h2 style={{ fontSize: "clamp(22px,3.5vw,34px)", fontWeight: 900, color: "#1c1917", margin: 0 }}>
                Fresh Picks for {today}
              </h2>
            </div>
            <button onClick={() => { setPage("specials"); window.scrollTo(0,0); }} style={{
              background: "none", border: "1px solid #c0390a", color: "#c0390a",
              borderRadius: "8px", padding: "9px 18px", fontSize: "13px", fontWeight: 700, cursor: "pointer",
...
*/ }
      ...
      <section style={{ padding: "70px 20px", background: "#fff" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <div style={{ fontSize: "13px", fontWeight: 700, color: "#c0390a",
              letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "6px" }}>⭐ Customer Favorites</div>
            <h2 style={{ fontSize: "clamp(22px,3.5vw,34px)", fontWeight: 900, color: "#1c1917", margin: 0 }}>
              Most Loved Dishes
            </h2>
          </div>
      ...
      <section style={{ padding: "70px 20px", background: "#fef7ef" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <h2 style={{ fontSize: "clamp(22px,3.5vw,34px)", fontWeight: 900, color: "#1c1917", margin: "0 0 12px" }}>
              Why Choose TK Home Foods?
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: "24px" }}>
            {[
              ...
              { icon: "📍", title: "Local Delivery",     desc1: "Proudly serving Miyapur, Matrusri Nagar, and nearby areas with timely delivery." },
            ].map(f => (
              <div key={f.title} style={{ background: "#fff", borderRadius: "16px", padding: "24px 20px",
            ...
            {[
              ...
              <div key={s.step} style={{ textAlign: "center" }}>
                <div style={{ width: "64px", height: "64px", borderRadius: "50%",
                  background: "linear-gradient(135deg,#c0390a,#e8520a)", margin: "0 auto 16px",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  boxShadow: "0 4px 16px rgba(192,57,10,0.3)" }}>
      ...
      <section style={{ padding: "70px 20px", background: "#fef7ef" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "40px" }}>
            <h2 style={{ fontSize: "clamp(22px,3.5vw,34px)", fontWeight: 900, color: "#1c1917", margin: "0 0 8px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: "20px" }}>
            {TESTIMONIALS.slice(0, 4).map(t => (
              <div key={t.id} style={{ background: "#fff", borderRadius: "16px", padding: "24px",
                boxShadow: "0 2px 12px rgba(0,0,0,0.07)" }}>
                <div style={{ display: "flex", gap: "2px", marginBottom: "12px" }}>
                  {[...Array(t.rating)].map((_,i) => <span key={i} style={{ color: "#f59e0b", fontSize: "14px" }}>★</span>)}
                </div>
                <p style={{ fontSize: "14px", color: "#374151", lineHeight: 1.6, margin: "0 0 16px", fontStyle: "italic" }}>
                  "{t.text}"
                </p>
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <div style={{ width: "36px", height: "36px", borderRadius: "50%",
                    background: "linear-gradient(135deg,#c0390a,#e8520a)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    color: "#fff", fontWeight: 700, fontSize: "14px" }}>{t.avatar}</div>
                  <div>
      ...
      <section style={{ padding: "60px 20px", background: "#fff" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontSize: "clamp(20px,3vw,30px)", fontWeight: 900, color: "#1c1917", margin: "0 0 8px" }}>
            📍 Already Delivering Fresh Food Across These Areas in Miyapur
          </h2>
          <p style={{ color: "#6b7280", fontSize: "15px", margin: "0 0 24px" }}>
            Fresh food delivered right to your neighbourhood
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", justifyContent: "center" }}>
            {CONFIG.DELIVERY_AREAS.map(area => (
              <span key={area} style={{ background: "#fef2f2", border: "1px solid #fecaca",
                borderRadius: "20px", padding: "8px 16px", fontSize: "13px", color: "#c0390a", fontWeight: 600 }}>
                📍 {area}
              </span>
            ))}
          </div>
          {/* <div style={{ marginTop: "32px", background: "#f9fafb", borderRadius: "16px", height: "220px",
            display: "flex", alignItems: "center", justifyContent: "center", border: "2px dashed #e5e7eb" }}>
      ...
      <section style={{ padding: "70px 20px", background: "linear-gradient(135deg,#1c1917,#2d1a12)" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontSize: "clamp(22px,3.5vw,34px)", fontWeight: 900, color: "#fff", margin: "0 0 12px" }}>
            Enjoy Home Food Every Day
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: "16px" }}>
            {[
              ...
              <div key={p.title} style={{ background: "rgba(255,255,255,0.08)", borderRadius: "16px",
                ...
                <span style={{ background: "rgba(192,57,10,0.4)", color: "#ffa07a",
                  borderRadius: "20px", padding: "4px 12px", fontSize: "11px", fontWeight: 700 }}>Coming Soon</span>
              </div>
            ))}
          </div>
          <button onClick={() => { setPage("contact"); window.scrollTo(0,0); }} style={{
            marginTop: "32px", background: "#c0390a", color: "#fff", border: "none",
            borderRadius: "10px", padding: "14px 32px", fontSize: "15px", fontWeight: 700, cursor: "pointer",
          }}>Get Notified →</button>
        </div>
      </section>
      ...
      <section style={{ padding: "70px 20px", background: "#fff" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "center" }}>
            <div>
              <div style={{ fontSize: "13px", fontWeight: 700, color: "#c0390a",
                textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "10px" }}>Bulk & Party Orders</div>
              <h2 style={{ fontSize: "clamp(22px,3vw,32px)", fontWeight: 900, color: "#1c1917", margin: "0 0 16px" }}>
                Catering for Every Occasion
              </h2>
              <p style={{ color: "#6b7280", fontSize: "15px", lineHeight: 1.6, margin: "0 0 20px" }}>
                Planning a birthday party, office meeting, family function, or festival celebration? We provide
                fresh, authentic Telangana and Andhra food for all your events.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "24px" }}>
                {["🎂 Birthday / Kitty Parties","🏢 Office / Pot-luck Lunch","👨‍👩‍👧 Family Functions","🎉 Festivals","💍 Special Occasions"].map(tag => (
                  <span key={tag} style={{ background: "#fef2f2", borderRadius: "6px",
                    padding: "5px 10px", fontSize: "12px", color: "#c0390a", fontWeight: 600 }}>{tag}</span>
                ))}
              </div>
              <button onClick={() => { setPage("contact"); window.scrollTo(0,0); }} style={{
                background: "#c0390a", color: "#fff", border: "none", borderRadius: "10px",
            ...
            {/* <div style={{ background: "#fef7ef", borderRadius: "20px", padding: "32px 24px" }}>
              ...
              <select style={{ width: "100%", padding: "11px 14px", borderRadius: "8px",
                border: "1px solid #e5e7eb", fontSize: "14px", marginBottom: "10px", background: "#fff", outline: "none" }}>
                <option>Number of People</option>
                {["10-25","25-50","50-100","100+"].map(n => <option key={n}>{n} people</option>)}
              </select>
              <textarea placeholder="Special requirements..." style={{
                width: "100%", padding: "11px 14px", borderRadius: "8px", border: "1px solid #e5e7eb",
                fontSize: "14px", height: "80px", resize: "vertical", boxSizing: "border-box", outline: "none",
              }} />
              <button style={{ width: "100%", background: "#c0390a", color: "#fff", border: "none",
                borderRadius: "8px", padding: "13px", fontSize: "14px", fontWeight: 700, cursor: "pointer", marginTop: "8px" }}>
                Send Enquiry
              </button>
            </div> */}
          </div>
    ...
    <main style={{ paddingTop: "64px" }}>
      ...
      <div style={{ position: "relative", height: "200px", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column",
          alignItems: "flex-start", justifyContent: "flex-end", padding: "28px 32px" }}>
          <nav style={{ fontSize: "13px", color: "rgba(255,255,255,0.7)", marginBottom: "8px" }}>
            <button onClick={() => { setPage("home"); window.scrollTo(0,0); }} style={{
              background: "none", border: "none", color: "#fbbf24", cursor: "pointer", padding: 0, fontSize: "13px", fontWeight: 600,
            }}>Home</button>
            <span style={{ margin: "0 8px" }}>›</span>
            <span>{cat.name} </span>
          </nav>
          <h1 style={{ fontSize: "clamp(24px,4vw,38px)", fontWeight: 900, color: "#fff", margin: "0 0 6px" }}>
            {cat.icon} {cat.name}
          </h1>
          <p style={{ color: "rgba(255,255,255,0.85)", margin: 0, fontSize: "15px" }}>{cat.description}</p>
        </div>
      </div>

      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "24px 20px 12px" }}>
  ...
  return (
    <main style={{ paddingTop: "64px" }}>
      <div style={{ background: "linear-gradient(135deg,#fff5e6,#fef2f2)", padding: "48px 20px 40px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "#fde8e0",
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px 80px" }}>
        <div style={{ background: "#fef2f2", borderRadius: "12px", padding: "14px 20px", marginBottom: "32px",
          display: "flex", alignItems: "center", gap: "10px" }}>
          <span style={{ fontSize: "18px" }}>⚡</span>
          <span style={{ fontSize: "14px", color: "#c0390a", fontWeight: 600 }}>
            Today's specials are freshly prepared in limited quantities. Order early to avoid missing out!
          </span>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(240px,1fr))", gap: "20px" }}>
    ...
    <main style={{ paddingTop: "64px" }}>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "60px 20px 80px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", marginBottom: "64px", alignItems: "center" }}>
          <div>
            <h2 style={{ fontSize: "28px", fontWeight: 900, color: "#1c1917", margin: "0 0 16px" }}>
              Authentic Telangana & Andhra Flavours
            </h2>
            <p style={{ color: "#6b7280", lineHeight: 1.7, marginBottom: "16px" }}>
              TK Home Foods brings together the authentic flavours of Telangana and Andhra with the warmth and comfort
              of home-style cooking. Located in the heart of Matrusri Nagar, Miyapur, we are proud to serve our
              community with food that feels genuine and wholesome.
            </p>
            <p style={{ color: "#6b7280", lineHeight: 1.7 }}>
              Our kitchen operates on the principle that good food should be simple, fresh, and full of flavour.
              We use traditional recipes, quality ingredients, and prepare everything fresh every day — no shortcuts, no compromises.
            </p>
          </div>
        ...
        <div style={{ background: "linear-gradient(135deg,#c0390a,#e8520a)", borderRadius: "20px",
          padding: "48px 40px", color: "#fff", textAlign: "center", marginBottom: "48px" }}>
          ...
          <p style={{ fontSize: "17px", lineHeight: 1.7, opacity: 0.9, margin: "0 auto", maxWidth: "560px" }}>
            To make authentic, wholesome Telangana and Andhra home food accessible to every household in Miyapur and
            beyond — prepared fresh, delivered with care, and made to feel like a meal from home.
          </p>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))", gap: "16px" }}>
          {[["🍱","4","Categories"],["🍽️","24+","Menu Items"],["📍","9+","Delivery Areas"],["⭐","4.8","Avg Rating"]].map(([icon,val,label]) => (
  ...
  return (
    <main style={{ paddingTop: "64px" }}>
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "48px 20px 80px",
        display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: "48px" }}>
        <div>
          ...
          {[
            ...
            <div key={c.label} style={{ display: "flex", gap: "14px", marginBottom: "20px" }}>
              <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: "#fef2f2",
                display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, fontSize: "18px" }}>{c.icon}</div>
              <div>
          ...
          {/* <button onClick={whatsapp} style={{ display: "flex", alignItems: "center", gap: "10px",
            background: "#25d366", color: "#fff", border: "none", borderRadius: "10px",
            padding: "13px 22px", fontSize: "14px", fontWeight: 700, cursor: "pointer", marginTop: "8px" }}>
            <span style={{ fontSize: "20px" }}>💬</span> Chat on WhatsApp
          </button> */}
          { /*<div style={{ marginTop: "24px", background: "#f9fafb", borderRadius: "14px", height: "180px",
            display: "flex", alignItems: "center", justifyContent: "center", border: "2px dashed #e5e7eb" }}>
            <div style={{ textAlign: "center", color: "#9ca3af" }}>
        ...
        {/* <div style={{ background: "#fef7ef", borderRadius: "20px", padding: "36px 28px" }}>
          ...
          {[
            { field: "name",  label: "Your Name",          type: "text",  ph: "Enter your name" },
            { field: "phone", label: "Phone Number",        type: "tel",   ph: "+91 9876543210" },
            { field: "email", label: "Email (optional)",    type: "email", ph: "you@example.com" },
          ].map(f => (
          ...
          <div style={{ marginBottom: "20px" }}>
            ...
            <textarea placeholder="Your message, order enquiry, or feedback..." value={form.message}
              ...
              style={{ width: "100%", padding: "11px 14px", borderRadius: "8px", border: "1px solid #e5e7eb",
                fontSize: "14px", height: "110px", resize: "vertical", boxSizing: "border-box", outline: "none", background: "#fff" }} />
          </div>
          <button onClick={handleSend} style={{ width: "100%", background: "#c0390a", color: "#fff", border: "none",
            borderRadius: "10px", padding: "14px", fontSize: "15px", fontWeight: 700, cursor: "pointer" }}>
  ...
  return (
    <main style={{ paddingTop: "64px" }}>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "32px 20px 80px",
        display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "32px" }}>
        {/* Form */}
        <div>
          <h2 style={{ fontSize: "18px", fontWeight: 800, color: "#1c1917", margin: "0 0 20px" }}>Delivery Details</h2>
          {[
            { field:"name",  label:"Your Name *",      type:"text", ph:"Full name" },
            { field:"phone", label:"Mobile Number *",  type:"tel",  ph:"+91 XXXXX XXXXX" },
          ].map(f => (
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              {[{val:"delivery",label:"🚚 Delivery"},{val:"pickup",label:"🏃 Pickup"}].map(o => (
                <button key={o.val} onClick={() => setForm(p => ({ ...p, delivery: o.val }))} style={{
                  ...
                  border: `2px solid ${form.delivery === o.val ? "#c0390a" : "#e5e7eb"}`,
          ...
          {[
            ...
            <button key={pm.val} onClick={() => setForm(p => ({ ...p, payment: pm.val }))} style={{
              ...
              border: `2px solid ${form.payment === pm.val ? "#c0390a" : "#e5e7eb"}`,
              ...
              <div style={{ marginLeft: "auto", width: "18px", height: "18px", borderRadius: "50%",
                border: `2px solid ${form.payment === pm.val ? "#c0390a" : "#d1d5db"}`,
                background: form.payment === pm.val ? "#c0390a" : "#fff" }} />
            </button>
          ))}
        </div>
          ...
          <div style={{ background: "#f9fafb", borderRadius: "16px", padding: "24px", position: "sticky", top: "80px" }}>
            ...
            {cart.map(item => (
              <div key={item.id} style={{ display: "flex", justifyContent: "space-between",
                ...
                <span style={{ color: "#374151" }}>{item.name.includes("<br/>")
    ? item.name.split("<br/>").map((part, index) => (
        <span key={index} style={{ display: "block" }}>
          {part}
        </span>
      ))
    : item.name} <span style={{ color: "#9ca3af" }}>×{item.qty}</span></span>
            ...
            <div style={{ padding: "12px 0 0" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "17px", fontWeight: 800,
                color: "#1c1917", borderTop: "2px solid #e5e7eb", paddingTop: "12px" }}>
                <span>Total</span><span style={{ color: "#c0390a" }}>₹{grandTotal}</span>
              </div>
            </div>
            <button onClick={placeOrder} style={{ width: "100%", background: "#c0390a", color: "#fff",
              border: "none", borderRadius: "10px", padding: "15px", fontSize: "15px", fontWeight: 700,
              cursor: "pointer", marginTop: "16px" }}>Place Order</button>
            <button onClick={whatsappOrder} style={{ width: "100%", background: "#25d366", color: "#fff",
...
/>
            ...
            <p style={{ fontSize: "14px", lineHeight: 1.6, color: "#a8a29e", marginBottom: "16px" }}>{CONFIG.TAGLINE}</p>
            {/* <div style={{ display: "flex", gap: "10px" }}>
              {["📘","📸","▶️","💬"].map((icon,i) => (
                <div key={i} style={{ width: "34px", height: "34px", borderRadius: "8px",
                  background: "rgba(255,255,255,0.08)", display: "flex", alignItems: "center",
                  justifyContent: "center", fontSize: "16px", cursor: "pointer" }}>{icon}</div>
              ))}
            </div> */}
          </div>
         {/* <div>
            <h3 style={{ color: "#fff", fontSize: "14px", fontWeight: 700, margin: "0 0 16px" }}>MENU</h3>
            {[["tiffins","Tiffins"],["meals","Rice"],["hot-items","Hot Items"],["sweets","Sweets"],["specials","Today's Specials1"]].map(([k,l]) => (
              <button key={k} onClick={() => go(k)} style={{ display: "block", background: "none", border: "none",
                color: "#a8a29e", fontSize: "14px", cursor: "pointer", padding: "4px 0" }}
                onMouseEnter={e => e.currentTarget.style.color="#c0390a"}
                onMouseLeave={e => e.currentTarget.style.color="#a8a29e"}>{l}</button>
            ))}
          </div> */ }
          <div>
            <h3 style={{ color: "#fff", fontSize: "14px", fontWeight: 700, margin: "0 0 16px" }}>COMPANY</h3>
            {[["home","Home"],["about","About Us"],["contact","Contact"]].map(([k,l]) => (
           <button key={k} onClick={() => go(k)} style={{ display: "block", background: "none", border: "none",
                color: "#a8a29e", fontSize: "14px", cursor: "pointer", padding: "4px 0" }}
                onMouseEnter={e => e.currentTarget.style.color="#c0390a"}
                onMouseLeave={e => e.currentTarget.style.color="#a8a29e"}>{l}</button>
          ...
          <div>
            <h3 style={{ color: "#fff", fontSize: "14px", fontWeight: 700, margin: "0 0 16px" }}>CONTACT</h3>
            <div style={{ fontSize: "13px", color: "#a8a29e", lineHeight: 1.8 }}>
              <div>📍 Matrusri Nagar, Miyapur</div>
  ...
  return (
    <a href={`https://wa.me/${CONFIG.WHATSAPP_NUMBER}?text=Hello! I'd like to order from TK Home Foods.`}
      ...
      style={{ position: "fixed", bottom: "80px", right: "20px", zIndex: 990,
        ...
        boxShadow: "0 4px 16px rgba(37,211,102,0.5)", textDecoration: "none", transition: "transform 0.2s" }}
...
export default function App() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case "meals":
      case "hot-items":
      case "sweets":    return <CategoryPage categoryId={page} setPage={setPage} />;
      case "specials":  return <SpecialsPage />;
