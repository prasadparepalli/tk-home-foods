...
function FoodImg({ imgKey, alt, style = {}, className = "" }) {
  ...
  if (!src || errored) {
    ...
    return (
      <div className={className} style={{ ...baseStyle, background: placeholderBg,
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 20px",
          ...
          <button onClick={() => go("home")} style={{ background: "none", border: "none", cursor: "pointer",
            ...
            <div style={{ textAlign: "left" }}>
              ...
              <div style={{ fontSize: "10px", color: "#c0390a", fontWeight: 600 }}>Miyapur, Hyderabad</div>
            </div>
          </button>
          ...
          <div>
           {/* <div style={{ display: "inline-flex", alignItems: "center", gap: "6px",
            ...
            <h1 style={{ fontSize: "clamp(28px,4.5vw,50px)", fontWeight: 900, color: "#1c1917",
              ...
              Authentic Telangana &amp; Andhra Food,{" "}
              <span style={{ color: "#c0390a" }}>Made Like Home</span>
            </h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "40px", marginBottom: "48px" }}>
         ...
         {/* <div>
          ...
          <div>
            ...
            {[["home","Home"],["about","About Us"],["contact","Contact"],["checkout","Order Now"]].map(([k,l]) => (
              <button key={k} onClick={() => go(k)} style={{ display: "block", background: "none", border: "none",
                color: "#a8a29e", fontSize: "14px", cursor: "pointer", padding: "4px 0" }}
                onMouseEnter={e => e.currentTarget.style.color="#c0390a"}
                onMouseLeave={e => e.currentTarget.style.color="#a8a29e"}>{l}</button>
